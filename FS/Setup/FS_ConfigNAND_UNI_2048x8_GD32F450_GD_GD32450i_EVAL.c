...
File    : FS_ConfigNAND_UNI_2048x8_GD32F450_GD_GD32450i_EVAL.c
Purpose : Configuration file for FS with Universal NAND driver and NAND flash.
*/
...
*/
#include "FS.h"
#include "FS_NAND_HW_GD32F450_GD_GD32450i_EVAL.h"
...
*/
#ifndef   ALLOC_SIZE
  #define ALLOC_SIZE          0x5000          // Size defined in bytes.
#endif

#ifndef   LOG_SECTOR_SIZE
  #define LOG_SECTOR_SIZE     2048            // Number of bytes in a logical sector.
                                              // It has to be larger than or equal to
                                              // the NAND flash page size (not counting the spare area.)
#endif
...
void FS_X_AddDevices(void) {
  ...
  //
  // Add and configure the NAND driver.
  //
  FS_AddDevice(&FS_NAND_UNI_Driver);
  FS_NAND_UNI_SetPhyType(0, &FS_NAND_PHY_2048x8);
  FS_NAND_UNI_SetECCHook(0, &FS_NAND_ECC_SW_1BIT);
  FS_NAND_2048x8_SetHWType(0, &FS_NAND_HW_GD32F450_GD_GD32450i_EVAL);
  //
  // The sector size of the file system must be large enough to store a NAND flash page.
  //
